 ...
 *   public/lms-architecture/deck.html
...
export default function Artifact() {
  ...
  // URL, not the route's. Forward the parent hash so /lms-architecture/#count
  ...
  return (
    ...
    >
      <iframe
        src={"/lms-architecture/deck.html" + hash}
        title="LMS Architecture Artifact"
        allow="fullscreen"
        allowFullScreen
