...
- Open edX: keep in mind for later LMS-style delivery, but do not start there.
...
Avoid a full LMS at the beginning. Open edX or similar platforms can come later
after the campus data model is stable.
