...
publication pages. It also validates every non-grandfathered AI-authored session
closeout against `registries/ai_report_audit.yaml`, including agent identity,
task/chat provenance, registered project/root, git baseline, authorization
scope, report path, and report-ID uniqueness.

Strict AI closeout audit only:
