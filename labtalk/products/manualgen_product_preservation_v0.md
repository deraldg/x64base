...
The hashes below preserve the 2026-07-04 observation and are not rolling
checksums of current tooling. Current manualgen state is recorded in
`manualgen_product_map_v0.md` and the audited session closeouts.
