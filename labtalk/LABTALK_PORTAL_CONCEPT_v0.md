...
| LMS | Shows the reserved local communications pipe and future Moodle boundary. |
...
| Python tool | Local LMS status or report helper | Run locally and capture a transcript. |
