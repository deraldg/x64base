...
| `assertion.portal.fullstack_trigger` | `invariant` | `trigger.fullstack_doc_push` | `["trigger.onboard", "trigger.change_source", "trigger.write_dotscript", "trigger.open_lane", "trigger.commit_or_push", "trigger.publish", "trigger.close_out", "trigger.plan_gates", "trigger.use_devtools", "trigger.understand_why", "trigger.release_or_license", "trigger.persistent_memory", "trigger.where_is", "trigger.read_write_dbf", "trigger.use_reference_authority", "trigger.capture_proof", "trigger.edit_website", "trigger.work_in_sandbox", "trigger.fullstack_doc_push"]` | true | 0 |
