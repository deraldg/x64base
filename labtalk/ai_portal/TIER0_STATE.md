# Tier 0 -- generated state projection
    ...
    generated_utc : 2026-08-25T12:34:16Z
    lane        : AIF-082 (6.1)
...
## Tree
    ...
    branch        : development
    HEAD          : ec38adac4  (2026-08-25)
    upstream      : a278b511e
    unpushed      : 22 commit(s) ahead of upstream
...
## Newest closeout
    ...
    commits behind HEAD : 108

## Staleness warnings

- The newest closeout is 108 commit(s) behind HEAD. Work has landed that no closeout describes; read `git log` as well.
- 22 commit(s) are unpushed and invisible to a clone.
