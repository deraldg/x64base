# Tier 0 -- generated state projection
    ...
    generated_utc : 2026-08-26T12:31:33Z
    lane        : AIF-082 (6.1)
...
## Newest closeout
    ...
    commits behind HEAD : 12

## Staleness warnings

- The newest closeout is 12 commit(s) behind HEAD. Work has landed that no closeout describes; read `git log` as well.
...
## Sessions, lineage, asides
    ...
    live   : CODEX-20260826-010  (member.ai.openai.codex)
...
| COWORK-20260825-001 | member.ai.claude.cowork | - | - | AIF-128 -> AIF-129 -> AIF-130 -> AIF-131 |
