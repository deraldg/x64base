# Tier 0 -- generated state projection
    ...
    generated_utc : 2026-08-19T12:26:20Z
    lane        : AIF-082 (6.1)
...
## Tree
    ...
    branch        : development
    HEAD          : 05af27848  (2026-08-19)
    upstream      : 2aad9b379
    unpushed      : 84 commit(s) ahead of upstream
...
## Newest closeout
    ...
    file          : SESSION_CLOSEOUT_APPLICATION_UI_DSL_LANE_2026-08-19.md
    commits behind HEAD : 6

## Staleness warnings

- The newest closeout is 6 commit(s) behind HEAD. Work has landed that no closeout describes; read `git log` as well.
- 84 commit(s) are unpushed and invisible to a clone.
...
## Sessions, lineage, asides
    ...
    live   : COWORK-20260818-001  (member.ai.claude.cowork)
