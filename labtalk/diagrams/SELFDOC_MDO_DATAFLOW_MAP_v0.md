...
- `HELP_MESSAGE_SELFDOC_COMPLETE_DFD_v1.md` - consolidated index and store/gate definitions for the complete HELP, message, metadata, SelfDoc, MDO, manualgen, and publication DFD pack.
- `help_message_selfdoc_context_dfd_v1.mmd` - system context and external entities.
- `help_message_selfdoc_level1_dfd_v1.mmd` - complete process and data-store flow.
- `help_message_selfdoc_level2_runtime_dfd_v1.mmd` - runtime messages, HELP DATA, metadata, and CMDHELPCHK detail.
- `help_message_selfdoc_level2_promotion_dfd_v1.mmd` - SelfDoc, proof, MDO, manualgen, review, and publication detail.
