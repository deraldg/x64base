...
class CrosswalkTests(unittest.TestCase):
    ...
    def test_current_build_counts_and_unique_ids(self):
        ...
        self.assertEqual("DOCFLUSH-20260716-001", manifest["run_id"])
    def test_explicit_run_id_is_recorded(self):
        _, _, manifest = MOD.build(ROOT, run_id="DOCFLUSH-20990101-001")
        self.assertEqual("DOCFLUSH-20990101-001", manifest["run_id"])
