...
def main():
    ...
    p22q1 = first_row(reports / "message_catalog_phase22q_1_status_summary_v1.csv")
    messages = p22q1.get("MESSAGES", "12")
    text_rows = p22q1.get("TEXT_ROWS", "60")
    locales = p22q1.get("LOCALES", "de;en-US;es;fr;it")
    ...
    gate("PHASE22Q_1_PATCH_APPLIED",
         p22q1.get("STATUS") == "MESSAGE_CATALOG_PHASE22Q_1_UNSUPPORTED_LOCALE_ROUTING_ANCHOR_REPAIR_APPLIED",
         p22q1.get("STATUS", ""))
