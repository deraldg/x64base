...
if (-not $AllowToolRepair) {
    throw "Refusing Phase 22AE.2 script repair without -AllowToolRepair"
}
...
$script = Join-Path $RepoRoot "tools\messaging\repair_message_catalog_phase22ae_2_execution_script_target_constants.py"
