...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22Y source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22y_set_message_proof_status_patch.py"
