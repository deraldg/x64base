...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22Y.1 source repair without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22y_1_build_signature_repair.py"
