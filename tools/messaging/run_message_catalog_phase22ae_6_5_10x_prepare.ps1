param(
    ...
    [switch]$AllowCandidate10AppendMicroProof,
...
$script = Join-Path $RepoRoot "tools\messaging\execute_message_catalog_phase22ae_6_5_10x_candidate10_append.py"
$argsList = @("--repo-root", $RepoRoot, "--mode", "prepare")
if ($AllowCandidate10AppendMicroProof) { $argsList += "--allow-candidate10-append-micro-proof" }
