...
$script = Join-Path $RepoRoot "tools\messaging\design_message_catalog_phase22ae_6_5_10bi_prewrite_native.py"
$argsList = @("--repo-root", $RepoRoot)
if ($ReplaceExistingDesign) { $argsList += "--replace-existing-design" }
