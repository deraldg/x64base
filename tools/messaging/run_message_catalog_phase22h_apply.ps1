...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22H source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22h_set_language_active_emission.py"
