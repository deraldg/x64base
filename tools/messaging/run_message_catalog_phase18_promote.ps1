...
if (-not $AllowActiveMessagingCatalogPromotion) {
    throw "Refusing Phase 18 active promotion without -AllowActiveMessagingCatalogPromotion"
}
...
$script = Join-Path $RepoRoot "tools\messaging\promote_message_catalog_phase18_active.py"
