...
$script = Join-Path $RepoRoot "tools\messaging\repair_message_catalog_phase22ae_6_5_3_1_1_v64_record_layout.py"
$argsList = @("--repo-root", $RepoRoot)
if ($AllowToolRepair) { $argsList += "--allow-tool-repair" }
