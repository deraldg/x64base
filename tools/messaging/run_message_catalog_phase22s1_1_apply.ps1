...
if (-not $AllowSourceMutation) { throw "Refusing Phase 22S1.1 source patch without -AllowSourceMutation" }
if (-not $PythonExe) {
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22s1_1_route_relocation.py"
