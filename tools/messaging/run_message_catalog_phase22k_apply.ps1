...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22K source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22k_placeholder_substitution.py"
