...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22E source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22e_status_hook.py"
