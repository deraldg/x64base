...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22M source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22m_set_language_routing.py"
