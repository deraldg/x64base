...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22E.3 source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22e_3_path_resolver_repair.py"
