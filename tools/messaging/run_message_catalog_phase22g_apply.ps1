...
if (-not $AllowSourceMutation) { throw "Refusing Phase 22G source patch without -AllowSourceMutation" }
if (-not $PythonExe) {
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22g_set_language_lookup.py"
