...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22F source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22f_active_dbf_loader.py"
