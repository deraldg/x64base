...
def main():
    ...
    ts=now_iso()
    entry=f"\n## {PHASE} - {ts}\n\n- status: {STATUS}\n- next_gate: {NEXT_GATE}\n- boundary: report-only/source-held; runtime exit crash triage reviewed; shutdown decision package required; no HELP DATA/CMDHELPCHK/source/DBF/CDX/LMDB/workspace mutation.\n"
