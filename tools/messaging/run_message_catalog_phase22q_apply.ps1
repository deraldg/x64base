...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22Q source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22q_unsupported_locale_routing.py"
