...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22C source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22c_provider_patch.py"
