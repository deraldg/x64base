...
$script = Join-Path $RepoRoot "tools\messaging\map_message_catalog_phase22ae_6_5_10bb_exact_targets.py"
$argsList = @("--repo-root", $RepoRoot)
if ($ReplaceExistingMap) { $argsList += "--replace-existing-map" }
