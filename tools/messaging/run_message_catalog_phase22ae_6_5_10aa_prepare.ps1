param(
    ...
    [switch]$AllowFull70TextSequence,
...
$script = Join-Path $RepoRoot "tools\messaging\execute_message_catalog_phase22ae_6_5_10aa_full70_text_sequence.py"
$argsList = @("--repo-root", $RepoRoot, "--mode", "prepare")
if ($AllowFull70TextSequence) { $argsList += "--allow-full70-text-sequence" }
