...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22O source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22o_gated_proof_lane.py"
