...
$script = Join-Path $RepoRoot "tools\messaging\triage_message_catalog_phase22ae_6_5_10cf_native_writer_discovery.py"
$argsList = @("--repo-root", $RepoRoot)
if ($ReplaceExistingTriage) { $argsList += "--replace-existing-triage" }
