...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 22I source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22i_argument_substitution.py"
