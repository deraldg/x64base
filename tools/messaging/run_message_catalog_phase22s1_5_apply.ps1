...
if (-not $AllowSourceMutation) { throw "Refusing Phase 22S1.5 source patch without -AllowSourceMutation" }
if (-not $PythonExe) {
...
$script = Join-Path $RepoRoot "tools\messaging\apply_message_catalog_phase22s1_5_header_escape_repair.py"
