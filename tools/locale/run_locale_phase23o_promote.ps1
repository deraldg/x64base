...
if (-not $AllowActiveSchemaPromotion) {
    throw "Refusing Phase 23O active schema promotion without -AllowActiveSchemaPromotion"
}
...
$script = Join-Path $RepoRoot "tools\locale\promote_locale_phase23o_active_schema_contract.py"
