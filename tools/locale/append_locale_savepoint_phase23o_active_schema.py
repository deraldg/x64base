...
SAVEPOINT_ID = "LOC-023O-ACTIVE-SCHEMA"
STATUS_EXPECTED = "LOCALE_PHASE23O_ACTIVE_LOCALE_SCHEMA_CONTRACT_VALIDATED_GREEN"
...
def main() -> int:
    ...
    summary = read_first(reports / "locale_phase23o_validation_status_summary_v1.csv")
    ...
    savepoint = {
        ...
        "lane": "LOCALE",
        "status": status,
        "phase": "Phase 23O active locale schema contract promotion",
        "validation_issues": summary.get("VALIDATION_ISSUES", ""),
        "active_locale_schema_present": summary.get("ACTIVE_LOCALE_SCHEMA_PRESENT", ""),
        "target_hash_matches_candidate": summary.get("TARGET_HASH_MATCHES_CANDIDATE", ""),
        "messaging_schema_promoted": summary.get("MESSAGING_SCHEMA_PROMOTED", ""),
        "next_gate": summary.get("NEXT_GATE", ""),
        "journal_anchor": SAVEPOINT_ID,
        "source_reports": "docs/locale/LOCALE_PHASE23O_ACTIVE_SCHEMA_CONTRACT_PROMOTION.md;docs/locale/reports/locale_phase23o_promotion_status_summary_v1.csv;docs/locale/reports/locale_phase23o_validation_status_summary_v1.csv;docs/locale/reports/locale_phase23o_active_schema_mutation_inventory_v1.csv;docs/locale/reports/locale_phase23o_active_schema_validation_inventory_v1.csv;docs/locale/reports/locale_phase23o_boundary_ledger_v1.csv;docs/locale/reports/locale_phase23o_validation_boundary_ledger_v1.csv",
        "boundary_summary": "active locale schema contract promoted only; messaging schema held; no active DBF/CDX/LMDB/source/runtime/HELP/CMDHELPCHK/manualgen/Data Dictionary/SelfDoc mutation",
    }
    ...
    with journal.open("a", encoding="utf-8", newline="\n") as f:
        ...
        f.write("Phase: Phase 23O active locale schema contract promotion\n\n")
        f.write("Boundary: active locale schema contract only; no DBF/CDX/LMDB/source/runtime/protected consumer mutation.\n\n")
