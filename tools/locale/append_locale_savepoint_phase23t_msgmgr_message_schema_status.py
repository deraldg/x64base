...
SAVEPOINT_ID = "LOC-023T-MSGMGR-MESSAGE-SCHEMA-STATUS"
STATUS_EXPECTED = "LOCALE_PHASE23T_MSGMGR_MESSAGE_SCHEMA_STATUS_BUILD_SMOKE_GREEN"
...
def main() -> int:
    ...
    summary = read_first(reports / "locale_phase23t_msgmgr_message_schema_status_validation_summary_v1.csv")
    ...
    savepoint = {
        ...
        "lane": "LOCALE",
        "status": status,
        "phase": "Phase 23T MSGMGR active message-schema status",
        ...
        "message_schema_active_path_proof": summary.get("MESSAGE_SCHEMA_ACTIVE_PATH_PROOF", ""),
        "messaging_schema_held_removed": summary.get("MESSAGING_SCHEMA_HELD_REMOVED", ""),
        "next_gate": summary.get("NEXT_GATE", ""),
        "journal_anchor": SAVEPOINT_ID,
        "source_reports": "docs/locale/LOCALE_PHASE23T_MSGMGR_MESSAGE_SCHEMA_STATUS.md;docs/locale/reports/locale_phase23t_msgmgr_message_schema_status_apply_summary_v1.csv;docs/locale/reports/locale_phase23t_msgmgr_message_schema_status_validation_summary_v1.csv;docs/locale/reports/locale_phase23t_msgmgr_message_schema_status_mutation_inventory_v1.csv;docs/locale/reports/locale_phase23t_msgmgr_message_schema_status_boundary_ledger_v1.csv;docs/locale/reports/locale_phase23t_msgmgr_message_schema_status_validation_boundary_v1.csv;docs/locale/runlog/LOC-023T_MSGMGR_MESSAGE_SCHEMA_STATUS_BUILD_AND_SMOKE_PROOF.md",
        "boundary_summary": "MSGMGR STATUS reports active locale and Messaging schema paths; no active schema/DBF/CDX/LMDB/HELP/CMDHELPCHK/manualgen/Data Dictionary/SelfDoc mutation",
    }
    ...
    with journal.open("a", encoding="utf-8", newline="\n") as f:
        ...
        f.write("Phase: Phase 23T MSGMGR active message-schema status\n\n")
