...
if (-not $AllowSourceMutation) {
    throw "Refusing Phase 23P MSGMGR schema-status source patch without -AllowSourceMutation"
}
...
$script = Join-Path $RepoRoot "tools\locale\apply_locale_phase23p_msgmgr_schema_status.py"
