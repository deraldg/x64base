...
SAVEPOINT_ID = "LOC-023Q-MESSAGE-SCHEMA-RECON"
STATUS_EXPECTED = "LOCALE_PHASE23Q_MESSAGE_CATALOG_SCHEMA_RECONCILIATION_GREEN_REPORT_ONLY"
...
def main() -> int:
    ...
    summary = read_first(reports / "locale_phase23q_message_schema_reconciliation_status_summary_v1.csv")
    ...
    savepoint = {
        ...
        "lane": "LOCALE",
        "status": status,
        "phase": "Phase 23Q message catalog schema reconciliation",
        "validation_issues": summary.get("VALIDATION_ISSUES", ""),
        "report_only_reconciliation": summary.get("REPORT_ONLY_RECONCILIATION", ""),
        ...
        "active_messaging_tables_reconciled": summary.get("ACTIVE_MESSAGING_TABLES_RECONCILED", ""),
        "dbf_field_rows": summary.get("DBF_FIELD_ROWS", ""),
        "phase22_report_rows": summary.get("PHASE22_REPORT_ROWS", ""),
        "schema_hint_rows": summary.get("SCHEMA_HINT_ROWS", ""),
        "next_gate": summary.get("NEXT_GATE", ""),
        "journal_anchor": SAVEPOINT_ID,
        "source_reports": "docs/locale/LOCALE_PHASE23Q_MESSAGE_CATALOG_SCHEMA_RECONCILIATION.md;docs/locale/reports/locale_phase23q_message_schema_reconciliation_status_summary_v1.csv;docs/locale/reports/locale_phase23q_active_messaging_artifact_inventory_v1.csv;docs/locale/reports/locale_phase23q_active_messaging_dbf_header_v1.csv;docs/locale/reports/locale_phase23q_active_messaging_dbf_fields_v1.csv;docs/locale/reports/locale_phase23q_message_schema_candidate_draft_v1.csv;docs/locale/reports/locale_phase23q_message_schema_promotion_plan_v1.csv;docs/locale/reports/locale_phase23q_boundary_ledger_v1.csv",
        "boundary_summary": "report-only message catalog schema reconciliation; candidate draft only; no active schema/DBF/CDX/LMDB/source/runtime/HELP/CMDHELPCHK/manualgen/Data Dictionary/SelfDoc mutation",
    }
    ...
    with journal.open("a", encoding="utf-8", newline="\n") as f:
        ...
        f.write("Phase: Phase 23Q message catalog schema reconciliation\n\n")
        f.write("Boundary: report-only candidate schema reconciliation; no active schema/catalog/protected mutation.\n\n")
