...
SAVEPOINT_ID = "LOC-023R-MESSAGE-SCHEMA-CLEAN"
STATUS_EXPECTED = "LOCALE_PHASE23R_MESSAGE_SCHEMA_CLEAN_CANDIDATE_GREEN_REPORT_ONLY"
...
def main() -> int:
    ...
    summary = read_first(reports / "locale_phase23r_message_schema_clean_candidate_status_summary_v1.csv")
    ...
    savepoint = {
        ...
        "lane": "LOCALE",
        "status": status,
        "phase": "Phase 23R message schema clean candidate",
        "validation_issues": summary.get("VALIDATION_ISSUES", ""),
        "report_only_clean_candidate": summary.get("REPORT_ONLY_CLEAN_CANDIDATE", ""),
        ...
        "raw_field_rows": summary.get("RAW_FIELD_ROWS", ""),
        "valid_field_rows": summary.get("VALID_FIELD_ROWS", ""),
        "filtered_descriptor_rows": summary.get("FILTERED_DESCRIPTOR_ROWS", ""),
        "tag_rows": summary.get("TAG_ROWS", ""),
        "tag_source": summary.get("TAG_SOURCE", ""),
        "next_gate": summary.get("NEXT_GATE", ""),
        "journal_anchor": SAVEPOINT_ID,
        "source_reports": "docs/locale/LOCALE_PHASE23R_MESSAGE_SCHEMA_CLEAN_CANDIDATE.md;docs/locale/reports/locale_phase23r_message_schema_clean_candidate_status_summary_v1.csv;docs/locale/reports/locale_phase23r_message_schema_valid_fields_v1.csv;docs/locale/reports/locale_phase23r_message_schema_filtered_descriptors_v1.csv;docs/locale/reports/locale_phase23r_message_schema_tag_rows_v1.csv;docs/locale/reports/locale_phase23r_message_schema_candidate_draft_v1.csv;docs/locale/reports/locale_phase23r_message_schema_promotion_plan_v1.csv;docs/locale/reports/locale_phase23r_message_schema_boundary_ledger_v1.csv",
        "boundary_summary": "report-only clean message schema candidate; invalid DBF descriptor rows filtered; no active schema/DBF/CDX/LMDB/source/runtime/HELP/CMDHELPCHK/manualgen/Data Dictionary/SelfDoc mutation",
    }
    ...
    with journal.open("a", encoding="utf-8", newline="\n") as f:
        ...
        f.write("Phase: Phase 23R message schema clean candidate\n\n")
        f.write("Boundary: report-only candidate cleanup; no active schema/catalog/protected mutation.\n\n")
