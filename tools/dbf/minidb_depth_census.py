...
EXTRACTING THE PAYLOADS
    ...
    catalog -- i.e. the objects of WORKSPACES.dtx beside WORKSPACES.dbf. The
    payloads used by R110 were written to tmp/minidb/NNN.bin, one file per
    object id; dtx_objects() below reads that store directly, so re-extraction
    needs nothing this file does not already contain.
"""
