...
For the index teaching model, see [CDX and LMDB Indexing](/docs/engine/cdx-lmdb-indexing). CDX is the logical container and command-facing manager; the physical backend depends on residence -- LMDB for built index environments on disk, native CDX-V64 in RAM.
