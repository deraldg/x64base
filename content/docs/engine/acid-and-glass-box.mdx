...
<a href="/images/story/x64base-glass-engine.png"><img src="/images/story/x64base-glass-engine.png" alt="The x64base Glass Engine cutaway: DBF work areas, record pointers, a vector header, CDX and LMDB-backed index lanes, commit, rollback, transaction log, command router, and CLI, TUI, GUI, and API ports" title="x64base Glass Engine" width="40%"></a>
