...
<a href="/docs/labtalk/cases-storyboard"><img src="/images/story/x64base-glass-engine.png" alt="The x64base Glass Engine cutaway illustrating the glass-box architecture — visible DBF storage, CDX and DDX indexes, commit, rollback, and transaction log" title="x64base Glass Engine" width="380" align="right"></a>
