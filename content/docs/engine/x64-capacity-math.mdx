...
- `D:\code\ccode\dottalkpp\data\scripts\canaries\x64_matrix_metrics_boundary_canary.dts`
...
- x64base local source evidence: `D:\code\ccode\include\xbase.hpp`, `include\xbase_vfp.hpp`, `include\xbase_64.hpp`, `include\memo\dtx_format.hpp`, and `include\memo\memostore.hpp`.
