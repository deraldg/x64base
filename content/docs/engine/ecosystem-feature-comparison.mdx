...
| A Bible verse on every startup | The banner prints a verse from a compiled-in SQLite carrier. It is also, incidentally, a working demonstration that the companion carrier is real and queryable at process start | runtime-proven, and yes, on purpose |
