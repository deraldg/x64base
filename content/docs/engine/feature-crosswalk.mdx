...
The report was generated from local source evidence plus harvested HELP/manualgen tables. It found `24` feature lanes, `290` harvested HELP commands, and source evidence across the configured scanner globs.
