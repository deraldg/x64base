...
[![x64base / DotTalk++ operational SDLC promotion workflow](/images/sdlc/dottalk-operational-sdlc-promotion-workflow.jpg)](/docs/labtalk/cases-storyboard)

The current promotion workflow starts in primary development, moves through
curated staging, optional runtime proof, and GitHub publication, then feeds the
website/manual evidence loop.
...
[![DotTalk++ runtime promotion path](/images/sdlc/dottalk-runtime-promotion-path.svg)](/docs/labtalk/cases-storyboard)
