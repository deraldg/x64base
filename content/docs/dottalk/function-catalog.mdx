...
Source extraction snapshot: `77` core documented expression functions,
...
| `DELETED` |  | Cursor | 0 | Is the current record flagged deleted? |
| `RECNO` |  | Cursor | 0 | Record number of the current record. |
| `RECCOUNT` |  | Cursor | 0 | Number of records in the current table. |
| `ISNULL` |  | Cursor | 1 | Is this field NULL in the current record? |
