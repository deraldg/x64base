...
"Minispaces" is a useful joke, not a product name. The serious idea behind it is
active Alpha work: multiple workspaces, recursive inspection, and nested containers.
The site distinguishes the already demonstrated MINIDB save/inspect/hydrate path
from the still-developing manager behavior around concurrency, recursion, nesting,
