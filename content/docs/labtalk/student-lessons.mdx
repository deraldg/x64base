...
turns this seed into a read-only learner pathway with objectives, setup,
observations, assessment questions, instructor notes, and an explicit evidence
boundary. It remains a guided draft pending instructor review.
