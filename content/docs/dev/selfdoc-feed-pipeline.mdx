...
[![SelfDoc feed pipeline from implementation evidence through HELP, metadata, SelfDoc, MDO, manualgen, and website publication](/images/sdlc/selfdoc-feed-pipeline-map.svg)](/docs/labtalk/cases-storyboard)
