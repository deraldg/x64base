...
- 191 current command-reference pages: 164 reader-linked, 19 supplemental, and
  8 post-baseline repair pages;
- 4,604 command lineage rows in the current local preview;
- zero publication-readiness findings.

The [accepted reader manifest](https://github.com/deraldg/x64base/blob/be9350531251bb682f0476d652d99ca137861577/docs/manuals/developer/manualgen/accepted_artifacts/primary_reader_artifact_v1.json)
and [accepted command-reference manifest](https://github.com/deraldg/x64base/blob/be9350531251bb682f0476d652d99ca137861577/docs/manuals/developer/manualgen/accepted_artifacts/command_reference_artifact_v1.json)
