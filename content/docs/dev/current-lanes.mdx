...
| DotScript | Active; command files, variables, loops, scans, comments, and line-continuation docs are now a product lane. |
...
| SQL/import/export | Active; SQL-like commands, SQLite wrapper, import/export, copy, and tuple export are command-visible. |
