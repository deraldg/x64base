...
| DotTalk++ artifact/manual room | Publication candidate, currently withheld from public navigation until HTTPS validates | Manualgen lane, command/reference export lane, generated SelfDoc/MDO reports, proof-packet lane, accessibility text lane, download governance lane | artifact manifest, route manifest, reviewed manual sections, command/function exports, generated reports, proof packets, accessibility status fields | Not a current public authority. Versioned artifacts belong on GitHub Releases; x64base.com remains the documentation site. |
