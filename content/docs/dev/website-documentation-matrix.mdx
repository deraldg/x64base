...
| DotTalk++ artifact/manual room | Local-only preview at `http://localhost:3001/`, with `/manuals`, `/dotscript`, `/reference`, `/generated`, `/downloads`, and `/governance` | Manualgen lane, command/reference export lane, generated SelfDoc/MDO reports, proof-packet lane, accessibility text lane, download governance lane | artifact manifest, route manifest, reviewed manual sections, command/function exports, generated reports, proof packets, accessibility status fields | Local preview only. x64base.com remains the main website; this surface handles larger artifacts and support materials. Replace localhost targets before public release. |
