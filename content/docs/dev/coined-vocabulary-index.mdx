---
title: "Coined Vocabulary -- Term Index"
description: "Generated index of the house coined vocabulary: every term, its one-line gloss, and where its definition lives. Derived from the maintained glossary in the source tree."
---

Derived index: GLOSSARY-INDEX-001

**GENERATED. Do not edit by hand.** This page is a derived projection of
`labtalk/ai_portal/AI_GLOSSARY_V1.md` in the source tree. Hand edits are overwritten and fail the
drift gate. Regenerate with `tools/fullstack_docs/glossary_sync.py emit`.
...
Definitions are NOT reproduced here. Each term names a home, and the home
holds the definition -- the glossary is a pointer index, and so is this.

Source extraction snapshot: 69 terms, 29 with a home, from `labtalk/ai_portal/AI_GLOSSARY_V1.md` at commit `0cfab2cea`.
