...
DotTalk++ is the interactive shell and runtime vocabulary. DotScript is the repeatable file and automation form: command sequences, variables, continuations, comments, loops, scans, validation runs, lab scripts, and reproducible database maintenance.
...
- `LOOP` / `ENDLOOP`.
- scan-style loops and `ENDSCAN`.
- variables and assignment.
- line continuation.
- comments.
- command files and include-ready examples.
