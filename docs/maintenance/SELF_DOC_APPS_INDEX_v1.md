...
Purpose: keep C++ wxWidgets, Python/Tkinter, and ArcticTalk/FoxTalk UI lanes
aligned over one DotTalk++ / x64base runtime truth.

Branding note:

- `ArcticTalk` is the public front-end umbrella.
- `Foxtalk` remains a valid fox-lineage subsystem name inside the Arctic family.
- This preserves historical command lineage without claiming clone behavior.

Current architecture documents:

- `docs/gui/ARCTICTALK_BRANDING_AND_LINEAGE_V1.md`
