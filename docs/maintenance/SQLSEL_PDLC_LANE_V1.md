...
| P6 | **USER MANUAL AND RUNTIME HELP UPDATED 2026-09-03.** The SQLsel chapter now documents the complete implemented algebra, typed TupleRow model, current-workspace resolver, SQL mode, DML, one-table transaction boundary, NULL/memo refusals, and all named gates. Source-owned usage and `sql_ref.hpp` were updated with it. Generated HELP DBFs, LabTalk lessons, evidence gallery, and public-site promotion remain separate deliberate publication work | G6 PARTIAL: source/manual current; generated/public surfaces deferred |
