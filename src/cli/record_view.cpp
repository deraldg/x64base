...
// File: src/cli/record_view.cpp
//
// PARKED -- NOT BUILT, AND NOT SAFE TO BUILD. This is a legacy duplicate: it
// defines the same xbase::DbArea members as src/xbase/record_view.cpp, which
// owns them. Excluded by name at src/CMakeLists.txt:180 ("This legacy
// duplicate implements DbArea methods inside the CLI. The physical
// implementation is owned exclusively by xbase.lib."), with the AIF-043
// duplicate-basename shadow guard behind it.
//
// Un-excluding it does not merely revive old behavior: an exe's own object
// silently wins over the static-library member, so this would SHADOW
// xbase.lib's implementation. That is what its sibling src/core/dbf_create.cpp
// did -- CREATE wrote to disk while USE read RAM, "a bug that no clean
// rebuild could surface" (src/CMakeLists.txt:182-189). That file is parked to
// .bak for the same reason; this one is parked in place.
//
// Do not edit this file expecting a behavior change. The live implementation
// is src/xbase/record_view.cpp.
