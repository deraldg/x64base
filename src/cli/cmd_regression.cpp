...
struct RegressionSpec {
    ...
    //
    // Fourteen specs mint; all fourteen now carry the flag. No spec outside
    // the workspace family mints, so the family filter was not hiding any.
...
constexpr std::array<RegressionSpec, 60> kRegressionSpecs{{
    {
        "NONDESTRUCTIVE",
