...
// AIF-074 P0.2: slot_of_area, ScopedAreaSelect, ScopedEngineArea,
// find_open_area_by_name_ci, and split_tuple_expr_csv moved to the shared
// home in workarea_util.{hpp,cpp}; behavior unchanged.
